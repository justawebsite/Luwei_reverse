...
module.exports = {
   ...
   */
  alert: function(message, completeCallback, title, buttonLabel, cancelable) {
    ...
    exec(completeCallback, null, "Notification", "alert", [_message, _title, _buttonLabel, cancelable]);
  },
  ...
  confirm: function(message, resultCallback, title, buttonLabels, cancelable) {
    ...
    exec(resultCallback, null, "Notification", "confirm", [_message, _title, _buttonLabels, cancelable]);
  },
   ...
   */
  prompt: function(message, resultCallback, title, buttonLabels, defaultText, cancelable) {
    var _message = (typeof message === "string" ? message : JSON.stringify(message));
    ...
    exec(resultCallback, null, "Notification", "prompt", [_message, _title, _buttonLabels, _defaultText, cancelable]);
  },
